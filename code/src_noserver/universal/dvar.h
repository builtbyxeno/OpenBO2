...
void Dvar_StringToColor(char const*, unsigned char* const);
...
int Dvar_ValuesEqual(enum dvarType_t, union DvarValue, union DvarValue);
...
struct dvar_t* Dvar_FindMalleableVar(long);
struct dvar_t* Dvar_FindMalleableVar(char const*);
struct dvar_t const* Dvar_FindVar(char const*);
struct dvar_t const* Dvar_FindVar(long);
void Dvar_ClearModified(struct dvar_t const*);
void Dvar_SetModified(struct dvar_t const*);
...
void Dvar_GetColor(struct dvar_t const*, unsigned char* const);
...
void Dvar_GetLatchedColor(struct dvar_t const*, unsigned char* const);
...
void Dvar_ChangeResetValue(struct dvar_t const*, union DvarValue);
...
struct dvar_t const* Dvar_RegisterNew(char const*, enum dvarType_t, unsigned int, union DvarValue, union DvarLimits, char const*);
void Dvar_AddFlags(struct dvar_t const*, int);
int Com_SaveDvarsToBuffer(char const** const, unsigned int, char*, unsigned int);
void Dvar_SetModifiedCallback(struct dvar_t const*, void (*)(struct dvar_t const*));
...
void Dvar_UpdateEnumDomain(struct dvar_t const*, char const** const);
...
struct dvar_t const* Dvar_RegisterVariant(char const*, enum dvarType_t, unsigned int, union DvarValue, union DvarLimits, char const*);
struct dvar_t const* _Dvar_RegisterBool(char const*, bool, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterInt(char const*, int, int, int, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterInt64(char const*, __int64, __int64, __int64, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterFloat(char const*, float, float, float, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterVec2(char const*, float, float, float, float, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterVec3(char const*, float, float, float, float, float, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterVec4(char const*, float, float, float, float, float, float, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterString(char const*, char const*, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterEnum(char const*, char const** const, int, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterColor(char const*, float, float, float, float, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterLinearRGB(char const*, float, float, float, float, float, unsigned int, char const*);
struct dvar_t const* _Dvar_RegisterColorXYZ(char const*, float, float, float, float, float, unsigned int, char const*);
void Dvar_SetBoolFromSource(struct dvar_t const*, bool, enum DvarSetSource);
void Dvar_SetIntFromSource(struct dvar_t const*, int, enum DvarSetSource);
void Dvar_SetInt64FromSource(struct dvar_t const*, __int64, enum DvarSetSource);
void Dvar_SetFloatFromSource(struct dvar_t const*, float, enum DvarSetSource);
void Dvar_SetVec2FromSource(struct dvar_t const*, float, float, enum DvarSetSource);
void Dvar_SetVec3FromSource(struct dvar_t const*, float, float, float, enum DvarSetSource);
void Dvar_SetVec4FromSource(struct dvar_t const*, float, float, float, float, enum DvarSetSource);
void Dvar_SetStringFromSource(struct dvar_t const*, char const*, enum DvarSetSource);
void Dvar_SetColorFromSource(struct dvar_t const*, float, float, float, float, enum DvarSetSource);
void Dvar_SetBool(struct dvar_t const*, bool);
void Dvar_SetInt(struct dvar_t const*, int);
void Dvar_SetFloat(struct dvar_t const*, float);
void Dvar_SetVec2(struct dvar_t const*, float, float);
void Dvar_SetVec3(struct dvar_t const*, float, float, float);
void Dvar_SetVec4(struct dvar_t const*, float, float, float, float);
void Dvar_SetVec4FromVec4(struct dvar_t const*, union vec4_t&);
void Dvar_SetString(struct dvar_t const*, char const*);
struct dvar_t const* Dvar_SetOrRegisterString(struct dvar_t const*, char const*, char const*);
void Dvar_SetColor(struct dvar_t const*, float, float, float, float);
void Dvar_SetFromStringFromSource(struct dvar_t const*, char const*, enum DvarSetSource);
void Dvar_SetFromString(struct dvar_t const*, char const*);
struct dvar_t const* Dvar_SetFromStringByNameFromSource(char const*, char const*, enum DvarSetSource, unsigned int);
void Dvar_SetFromStringByName(char const*, char const*);
void Dvar_SetCommand(char const*, char const*);
void Dvar_Reset(struct dvar_t const*, enum DvarSetSource);
...
void Dvar_SetBoolIfChanged(struct dvar_t const*, bool);
void Dvar_SetIntIfChanged(struct dvar_t const*, int);
void Dvar_SetFloatIfChanged(struct dvar_t const*, float);
void Dvar_SetStringIfChanged(struct dvar_t const*, char const*);
