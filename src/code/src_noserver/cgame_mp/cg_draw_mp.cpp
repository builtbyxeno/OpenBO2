...
/*
==============
CG_CheckVehicleControlsDisplay
==============
*/
...
/*
==============
CG_UsingAirborneKillstreakOverlay
==============
*/
...
==============
*/
void CG_Draw2D(LocalClientNum_t localClientNum)
{
	UNIMPLEMENTED(__FUNCTION__);
}
