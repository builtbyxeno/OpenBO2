...
void __thiscall Actor_Generic_Pain(bdLobbyEventHandler *this, unsigned __int64 __formal, const char *vPoint, void *iMod, unsigned int vDir);
...
;
// bool Actor_CanShootEnemy@<al>(actor_t *self@<ecx>, const int cacheDuration@<edx>, const char *a3@<edi>);
...
// void Avoid_UpdateGoal(char *a1@<edi>, int index, const float dt, const vec3_t *position, const vec3_t *vel, vec3_t *goalPos, float *speed, int team);
