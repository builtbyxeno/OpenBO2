...
/*
==============
CScr_GetColumnTypeByName
==============
*/
scoreboardColumnType_t CScr_GetColumnTypeByName(const char *typeName)
{
	UNIMPLEMENTED(__FUNCTION__);
	scoreboardColumnType_t tmp;
	return tmp;
}

/*
==============
CScr_GetColumnNameByType
==============
*/
