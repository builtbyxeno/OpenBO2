...
int Mantle_GetDuration(const MantleState *this);
...
// void mover_info_t::init(mover_info_t *this, const vec3_t *origin, const vec3_t *angles, int time);
// void mover_info_t::add_record(mover_info_t *this, const vec3_t *origin, const vec3_t *angles, int time);
// void mover_info_t::get_position(mover_info_t *this, int time, vec3_t *origin, vec3_t *angles);
...
// void sv_rewind_context_t::sv_rewind_context_t(sv_rewind_context_t *this, int mover_num, int from_time, int to_time, vec3_t *origin, vec3_t *angles, gentity_t *ent_to_link);
// void actors_rewind_context_t::rewind(actors_rewind_context_t *this, int from_time, int to_time, int _mover_num);
...
// bool gjk_double_sphere_t::is_foot(gjk_double_sphere_t *this, const phys_vec3 *hit_point);
// bool gjk_polygon_cylinder_t::is_foot(gjk_polygon_cylinder_t *this, const phys_vec3 *hit_point);
// bool gjk_brush_t::is_walkable(gjk_brush_t *this, const phys_vec3 *hit_point, const phys_vec3 *up);
// bool gjk_partition_t::is_walkable(gjk_partition_t *this, const phys_vec3 *hit_point, const phys_vec3 *up);
...
// gjkcc_info *gjkcc_info_database_t::gjkcc_info_find(gjkcc_info_database_t *this, const unsigned int gjkcc_id, const bool is_server_thread);
...
// gjkcc_info *gjkcc_info_database_t::create_gjkcc_info(gjkcc_info_database_t *this, const gjkcc_input_t *gjkcc_in, const bool is_server_thread, const vec3_t *origin);
void destroy_gjkcc_info(void *gcci_);
// gjkcc_info *gjkcc_info_database_t::gjkcc_info_find_or_create(gjkcc_info_database_t *this, const gjkcc_input_t *gjkcc_in, const bool is_server_thread, const vec3_t *origin);
// void gjkcc_info_database_t::gjkcc_info_destroy(gjkcc_info_database_t *this, const unsigned int gjkcc_id, const bool is_server_thread);
// void gjkcc_info_database_t::gjkcc_info_destroy_all(gjkcc_info_database_t *this, const bool is_server_thread);
...
itemInfo_t* BG_UnlockablesGetItemRefHash();
int BG_UnlockablesGetItemCount();
itemInfo_t *BG_UnlockablesGetItemUnlockLevel();
itemInfo_t *BG_UnlockablesGetItemUnlockPLevel();
itemInfo_t *BG_UnlockablesGetItemMomentumCost();
itemInfo_t *BG_UnlockablesGetItemAllocationCost();
itemInfo_t *BG_UnlockablesGetRealItemCost();
int BG_UnlockablesGetItemCost();
int BG_UnlockablesGetItemDualWieldCost();
int BG_UnlockablesGetItemDualWieldIndex();
int BG_UnlockablesGetItemDualWieldBaseIndex();
int BG_UnlockablesGetNumItemAttachmentsWithAttachPoint(int itemIndex, int attachPoint);
int BG_UnlockablesGetNumItemAttachments();
...
const char *BG_UnlockablesGetItemGroup();
int BG_UnlockablesGetItemGroupEnum();
int BG_UnlockablesGetItemLoadoutSlot();
...
unsigned __int8 BG_UnlockablesGetItemDLCIndex();
char BG_UnlockablesIsItemDLCAvailable(const ControllerIndex_t controllerIndex);
bool BG_UnlockablesItemHasDualWield();
bool BG_UnlockablesItemIsDualWield();
...
// char validateCACStatus_s::verifyUnusedAttachmentSlotsCheck(validateCACStatus_s *this, loadoutSlot_t startIndex, loadoutSlot_t endIndex, int maxAllowedAttachments);
// void validateCACStatus_s::Print(validateCACStatus_s *this);
// void validateCACStatus_s::Initialize(validateCACStatus_s *this, ControllerIndex_t localControllerIndex_Input, const CACRoot cacRoot_Input, loadoutClass_t customClass_Input);
...
bool BG_UnlockablesDLCWeaponDisabled();
...
// int validateCACStatus_s::ValidateClass_GetNumItemAttachments(validateCACStatus_s *this, loadoutSlot_t loadoutSlotType, int itemIndex, int foundIndex);
// bool validateCACStatus_s::ValidateClass_BonusCard_PrerequisitesAndRules(validateCACStatus_s *this, int itemIndex, loadoutSlot_t slotIndex);
// void validateCACStatus_s::ValidateClass_BonusCards(validateCACStatus_s *this, loadoutSlot_t a2);
// bool validateCACStatus_s::ValidateClass_AdditionalGrenadeCheck(validateCACStatus_s *this, int itemIndex, int slotIndex);
...
// char validateCACStatus_s::ValidateClass_NoConflictingAttachments(validateCACStatus_s *this, int baseWeapon_itemIndex, int curr_AttachmentIndex, eAttachment curr_Attachment, int curr_SlotIndex, int startRangeInclusive, int stopRangeInclusive);
...
void PM_ResetWeaponState(playerState_s *this);
...
// void WeaponVariantDefHash::Set(WeaponVariantDefHash *this, int wi);
